...
export default function GolfSite() {
  ...
  if (tab === 'entrance') {
    return (
      <div style={{
        backgroundImage:
          'url(https://golfdigest.sports.sndimg.com/content/dam/images/golfdigest/fullset/2017/10/07/59d9000722bd233920d352c5_Jeffersonville%203.JPG.rend.hgtvcom.966.644.suffix/1573348146565.jpeg)',
      ...
      >
        ...
        >
          <button
            onClick={() => setTab('teeTimes')}
            style={{
              background: tab === 'teeTimes' ? '#3e513d' : '#ddd',
              color: tab === 'teeTimes' ? 'white' : '#333',
              border: 'none',
              padding: '10px 20px',
              borderRadius: '6px',
              fontSize: '16px'
          ...
          <button
            ...
            style={{
              background: tab === 'majors' ? '#3e513d' : '#ddd',
              color: tab === 'majors' ? 'white' : '#333',
              border: 'none',
              padding: '10px 20px',
              borderRadius: '6px',
              fontSize: '16px'
          ...
          <button
            ...
            style={{
              background: tab === 'rules' ? '#3e513d' : '#ddd',
